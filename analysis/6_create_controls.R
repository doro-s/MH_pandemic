...
# Run matching
incidence_group <- match_exposed_to_controls(incidence_exposed, incidence_control, 3)
prevalence_group <- match_exposed_to_controls(prevalence_exposed, prevalence_control, 3)
